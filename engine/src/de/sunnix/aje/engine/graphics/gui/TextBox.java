...
import de.sunnix.aje.engine.graphics.FloatArrayBuffer;
import de.sunnix.aje.engine.graphics.Mesh;
...
public class TextBox extends MemoryHolder implements IGUIComponent {
    ...
    private Mesh createMesh(int width, int height){
        ...
        return new Mesh(indices, new FloatArrayBuffer(vertices, 3, true), new FloatArrayBuffer(textures, 2, true));
    }
